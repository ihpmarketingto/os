...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: "CRM", href: "/crm", icon: Users, phase: 0, flagKey: "crm" },
  { label: "Clients", href: "/clients", icon: Building2, phase: 0, flagKey: "crm" },
  { label: "Bookings", href: "/bookings", icon: CalendarCheck, phase: 0, flagKey: "crm" },
  { label: "Projects", href: "/projects", icon: FolderKanban, phase: 0 },
  { label: "Tasks", href: "/tasks", icon: CheckSquare, phase: 0 },
  { label: "Content Studio", href: "/content-studio", icon: PenSquare, phase: 0 },
  { label: "Creative Studio", href: "/creative-studio", icon: Palette, phase: 0 },
  { label: "Campaigns", href: "/campaigns", icon: Megaphone, phase: 0 },
  { label: "Paid Media", href: "/paid-media", icon: Target, phase: 0 },
  { label: "SEO", href: "/seo", icon: Search, phase: 0 },
  { label: "Website and CRO", href: "/website-cro", icon: Globe, phase: 0 },
  { label: "Email and Lifecycle", href: "/email-lifecycle", icon: Mail, phase: 0 },
  { label: "PR, Influencers and Partnerships", href: "/pr-influencers", icon: Handshake, phase: 0 },
  ...
  { label: "Knowledge", href: "/knowledge", icon: BookMarked, phase: 0 },
